...
module.exports = class WebdriverError extends Error {
  constructor(typeInfo, message = '') {
    const fullMessage = `${typeInfo.state} ${message}`;
    super(fullMessage);
    Object.assign(this, typeInfo);
  }
};

// todo: fill state and httpStatus for all errors
